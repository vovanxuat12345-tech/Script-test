-- ========================================================
--        MADE BY CHIẾN ĐO EXPLOIT (SUPER SPEED UPDATE)
-- ========================================================
...
local DEFAULT_SETTINGS = {
    ...
    FLY_SPEED = 250,      -- Đã tăng lên 500 studs/s siêu tốc độ
...
-- Biến toàn cục theo dõi Stage hiện tại để xử lý Miss Stage
...
local function flyToTarget(target)
    ...
    -- Độ cao bay nhấc lên = 0 (Bay sát đất theo yêu cầu)
    ...
    -- PHẦN XỬ LÝ ĐẶC BIỆT CHO STAGE 243 CỦA BỒ
    ...
    task.wait(DEFAULT_SETTINGS.WAIT_TIME) -- Nghỉ 0.35s chuẩn bài
end
...
local function startFarming()
    ...
    task.spawn(function()
        ...
        while running do
            ...
            -- Quét tìm checkpoint gần nhất hiện tại
            ...
            -- ========================================================
            -- 🚨 CƠ CHẾ PHÁT HIỆN MISS STAGE VÀ TRỪ 1 STAGE (ANTI-TELEPORT)
            -- ========================================================
            if currentTargetStageNum ~= -1 and closestStageNum < currentTargetStageNum - 1 then
                print("CHIẾN ĐO WARNING: Phát hiện bị giật lùi về Stage cũ! Tiến hành -1 Stage gỡ kẹt.")
                -- Ép hệ thống quay lại nhặt Checkpoint bị bỏ lỡ
                closestStageNum = closestStageNum - 1 
            end
            
            -- Tính toán Stage mục tiêu tiếp theo
